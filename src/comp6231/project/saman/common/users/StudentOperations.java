...
public interface StudentOperations extends Remote {
	...
	ArrayList<TimeSlotResult> getAvailableTimeSlot(String user_id, DateReservation date) throws RemoteException, NotBoundException, IOException, InterruptedException;
