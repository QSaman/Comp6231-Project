	...
	private static String processData(String json) throws Exception{
		...
		if (isFeToServer) {
			...
			if (json.startsWith("signInStudent")) {
				...
				packetToSend = ServerWestmount.bookRoom(tempStudentID,campus,tempRoomNumber, LocalDate.of(year, month, day),
				...
				packetToSend = ServerWestmount.getAvailableTimeSlot(tempStudentID, LocalDate.of(year, month, day));
			...
			packetToSend = ServerWestmount.changeReservation(tempStudentID, bookingID, campus, tempRoomNumber,
				...
				packetToSend = ServerWestmount.createRoom(adminID, roomNumber, LocalDate.of(year, month, day), listOfTimeSlots);
				...
				packetToSend = ServerWestmount.deleteRoom(adminID, roomNumber, LocalDate.of(year, month, day), listOfTimeSlots);
			}
		}
		else 
		{
