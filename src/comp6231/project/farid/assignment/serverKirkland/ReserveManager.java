...
public class ReserveManager {
    ...
    private void resetCounterInOtherServers() throws Exception {
        ...
        DatagramPacket sendPacket3 = new DatagramPacket(sendData3, sendData3.length, IPAddress3, 9635);
        ...
        DatagramPacket sendPacket4 = new DatagramPacket(sendData4, sendData4.length, IPAddress4, 9763);
